...
fun RegistrationScreen(
    ...
    Surface(
        ...
        if (uiState.isRegistered) {
            // Success state: show activation-pending message
            Column(
                modifier = Modifier
                    .fillMaxSize()
                ...
                Text(
                    text = uiState.registrationMessage ?: "Akun Anda menunggu aktivasi oleh admin.",
                ...
                Column(
                    ...
                    Column(
                        ...
                        OutlinedTextField(
                            ...
                            enabled = !uiState.isLoading,
                            supportingText = { Text("PIN akan digunakan untuk membuka aplikasi") }
                        )
